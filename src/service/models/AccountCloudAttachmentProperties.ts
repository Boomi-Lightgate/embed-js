...
/* tslint:disable */
/* eslint-disable */
export type AccountCloudAttachmentProperties = {
    /**
     * Represented in bytes, this property sets the size limit for an account that uses the private Runtime cloud.
     */
    accountDiskUsage?: number;
    /**
     * Used to select the process run mode for AS2 listener processes.Accepted values:<br />1. inherited — \(Default\) The setting is inherited from the Runtime cluster.<br />2. general — The default process mode for all new processes.<br />3. low\_latency\_debug — All AS2 listener processes use an execution worker.
     ...
     */
    as2Workload?: AccountCloudAttachmentProperties.as2Workload;
    /**
     ...
     */
    atomWorkingOverflowSize?: number;
    /**
     ...
     */
    cloudAccountExecutionLimit?: number;
    /**
     ...
     */
    flowControlParallelProcessTypeOverride?: AccountCloudAttachmentProperties.flowControlParallelProcessTypeOverride;
    /**
     ...
     */
    minNumberofAtomWorkers?: number;
    /**
     * Allocated number of execution workers.
     */
    numberofAtomWorkers?: number;
    /**
     ...
     */
    queueIncomingMessageRateLimit?: number;
    sessionId?: string;
    statusCode?: number;
    /**
     ...
     */
    testModeMaxDocs?: number;
    workerElasticScalingThreshold?: number;
    /**
     ...
     */
    workerMaxExecutionTime?: number;
    /**
     * Maximum run time in milliseconds for Execution worker processes that use Low\_Latency\_Debug mode. For example, an accepted value is 60000. After you change this property value, you must restart the Runtime cloud cluster or Runtime.
     */
    workerMaxGeneralExecutionTime?: number;
    /**
     ...
     */
    workerMaxQueuedExecutions?: number;
    /**
     ...
     */
    workerMaxRunningExecutions?: number;
    /**
     ...
     */
    workerQueuedExecutionTimeout?: number;
};
export namespace AccountCloudAttachmentProperties {
    /**
     * Used to select the process run mode for AS2 listener processes.Accepted values:<br />1. inherited — \(Default\) The setting is inherited from the Runtime cluster.<br />2. general — The default process mode for all new processes.<br />3. low\_latency\_debug — All AS2 listener processes use an execution worker.
     * >**Note:** After you change this property value you must restart the Runtime cloud cluster or Runtime. <br /><br />If you select Low\_Latency\_Debug, Trading Partner components that use AS2 listeners also use that run mode.
     */
    export enum as2Workload {
        GENERAL = 'GENERAL',
        LOW_LATENCY_DEBUG = 'LOW_LATENCY_DEBUG',
    }
    /**
     * Overrides the **Parallel Process Type** setting in **Flow Control** shapes at a global Runtime cloud or Attachment Quota level. You can set the property only if you are a private Runtime cloud owner.The default value is NONE.
     */
    export enum flowControlParallelProcessTypeOverride {
        NONE = 'NONE',
        THREADS = 'THREADS',
        PROCESSES = 'PROCESSES',
    }
