...
export type ExecutionConnector = {
     ...
     */
    executionConnector?: string;
    /**
     * The ID of the process run.
     */
    executionId?: string;
    /**
     * A unique ID generated for this connector record.
     */
    id?: string;
    /**
     * If the value is set to true, this indicates the given execution connector is the **Start** shape of the process. If the value is set to false, this indicates that the given execution connector is not the **Start**shape of the process.
     */
    isStartShape?: boolean;
    /**
     * The type of connector record: tradingpartner, connector, nodata, or return.
     */
    recordType?: string;
    /**
     * The total size of all documents tracked by the given execution connector, in bytes.
     */
    size?: number;
    /**
     * The count of successful documents on the given execution connector, where a successful run is one with a status of **complete**.
     */
    successCount?: number;
};
